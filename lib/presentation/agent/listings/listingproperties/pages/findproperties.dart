          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() {
                  return switch (controller.findPropertiesState.value) {
                    FindPropertiesState.loading =>
                      Screens.loading(height: 500.h),
                    FindPropertiesState.loaded => _loaded(),
                    FindPropertiesState.empty => _empty(),
                    FindPropertiesState.searching => _searching(),
                    FindPropertiesState.error => _error(),
                  };
                }),
              ],
            ),
