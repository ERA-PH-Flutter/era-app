                      ...
                      return controller.selectionModeActive.value
                          ? Row(
                            ...
                            children: [
                              ElevatedButton.icon(
                                onPressed: () {
                                  for (var selected in controller.selectedItems) {
                                    controller.selectedListings.add(controller.favoritesList[selected]);
                                  }
    ...
    controller.showSuccessDialog(title: "Success",description: "PDF has been downloaded",hitApi: (){
      AwesomeNotifications().createNotification(
          content: NotificationContent(
            ...
            body: 'Pdf file has been downloaded, look for $pdfFileName at the download folder!',
          )
      );
      Get.back();Get.back();
    });
          ...
          return Screenshot(
            ...
            child: Column(
              children: [
                ...
                index != 0 ? SizedBox(height: 130.h,) : Container()
              ],
            ),
          );
        },
