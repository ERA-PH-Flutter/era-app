                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Button(
                        ...
                        onTap: ()async{
                          try{
                            var sellDoc = FirebaseFirestore.instance.collection('sell_properties').doc();
                            await sellDoc.set({
                              'id' : sellDoc.id,
                            ...
                            BaseController().showSuccessDialog(
                              title: "Success",
                              description: "Your Property info has been submitted to admin. Wait for an admin to contact you!",
                              hitApi: (){
