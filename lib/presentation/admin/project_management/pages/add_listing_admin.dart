                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                    Button(
                      onTap: () async {
                        ...
                        if (addListingsController.propertyNameController.text.isEmpty) {
                          showErroDialogs(
                            title: "Error",
                            description:
                        ...
                        if (addListingsController.propertyCostController.text.isEmpty) {
                          showErroDialogs(
                            title: "Error",
                        ...
                        if (addListingsController.pricePerSqmController.text.isEmpty) {
                          showErroDialogs(
                            title: "Error",
                            description: "All fields are required!",
                          );
                        ...
                        if (addListingsController.bathsController.text.isEmpty) {
                          showErroDialogs(
                            title: "Error",
                            description: "All fields are required!",
                          );
                        ...
                        if (addListingsController.addressController.text.isEmpty) {
                          showErroDialogs(
                            title: "Error",
                            description: "All fields are required!",
                          );
                        ...
                        if (addListingsController.selectedOfferT.value == null) {
                          showErroDialogs(
                            title: "Error",
                            description: "All fields are required!",
                          );
                        ...
                        if (addListingsController.selectedPropertyT.value == null) {
                          showErroDialogs(
                            title: "Error",
                            description: "All fields are required!",
                          );
                        ...
                        if (addListingsController.selectedPropertySubCategory.value == null) {
                          showErroDialogs(
                            title: "Error",
                            description:
                            "All fields are required! Only Description is optional",
