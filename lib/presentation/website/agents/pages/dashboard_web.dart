...
class AgentDashBoardWeb extends GetResponsiveView<AgentDashboardWebController> {
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(
          ...
          child: SingleChildScrollView(
            child: Row(children: [
              for (int i = 0; i < controller.favorites.length && i < 5; i++)
                GestureDetector(
                  onTap: () {
                    Get.delete<ListingsWebController>();
                    Get.toNamed('/view-listing/${controller.favorites[i].id}');
                  },
                  child: Container(
                      width: 200.w,
                      height: 190.h,
                      ...
                      child: Stack(
                        children: [
                          Positioned.fill(
                            child: CloudStorage().imageLoaderProvider(
                                reference: controller.favorites[i].photos.first,
                                height: 80.h,
                                width: 120.w,
                                borderRadius: BorderRadius.circular(10.r)),
                          ),
                          Positioned(
                            ...
                            child: Container(
                              ...
                              child: EraText(
                                textAlign: TextAlign.center,
                                text: controller.favorites[i].name,
                                color: Colors.black,
                                fontSize: 20.sp,
                                textOverflow: TextOverflow.ellipsis,
                                fontWeight: FontWeight.w400,
  ...
  Widget findAgentsandOffices(width, height) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        EraText(
          ...
          child: SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...
                for (int i = 0; i < controller.listings.length && i < 5; i++)
                  GestureDetector(
                    onTap: () {
                      Get.delete<ListingsWebController>();
                      Get.toNamed('/view-listing/${controller.listings[i].id}');
                    },
                    child: Container(
                      width: 200.w,
                      height: 190.h,
                      ...
                      child: Stack(
                        children: [
                          Positioned.fill(
                            child: CloudStorage().imageLoaderProvider(
                              reference:
                                  controller.listings[i].photos.isNotEmpty
                                      ? controller.listings[i].photos.first
                                      : AppStrings.noUserImageWhite,
                              height: 80.h,
                              width: 120.w,
                              borderRadius: BorderRadius.circular(10.r),
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              child: EraText(
                                textAlign: TextAlign.center,
                                text: controller.listings[i].name,
                                color: Colors.black,
                                fontSize: 20.sp,
                                textOverflow: TextOverflow.ellipsis,
                                fontWeight: FontWeight.w400,
  ...
  Widget iconAgents(
      String assetPath, Function()? onTap, String name, width, height) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
        child: Column(
