  ...
  _loaded() {
    ...
    return Column(
      children: [
        ...
        //                   int pageViewIndex) {
        //                 var image = controller.images[itemIndex];
                ...
                child: Column(
                  children: [
                    EraText(
                      ...
                      text:
                          'Connect worlds, build dreams with ERA Philippines;',
                      color: AppColors.kRedColor,
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                width: 378.w,
                                margin:
                                    EdgeInsets.only(bottom: 16.h, right: 10.w),
