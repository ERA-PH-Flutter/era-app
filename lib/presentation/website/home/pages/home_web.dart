...
class HomeWeb extends GetResponsiveView<HomeWebController> {
  HomeWeb({super.key});
  ...
  Widget builder() {
    return WillPopScope(
      ...
      child: SafeArea(
        child: Obx(() {
          switch (controller.homelandingState.value) {
            case HomeWebState.loading:
              return _loading();
            case HomeWebState.loaded:
              return _buildResponsiveUI();
            case HomeWebState.error:
              return _error();
            case HomeWebState.empty:
              return _empty();
            default:
              return _loading();
          }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsets.symmetric(
                      horizontal: EraTheme.paddingWidthAdmin * 2),
                  child: FilteredSearchBox(),
                ),
                sb15(),
                controller.quickLinks!,
  ...
  static Widget buildFeatureIcon(
      {required String icon, required String label, double? fontSize}) {
    return Row(
      children: [
        Image.asset(
          icon,
        ...
        EraText(
          text: label,
          fontSize: fontSize ?? EraTheme.sbodyText + 10.sp,
          fontWeight: FontWeight.w500,
          color: AppColors.black,
        ),
      ],
