...
import '../../../presentation/website/listings/pages/archivedlisting/controllers/archived_controller.dart';
...
class ArchivedItems extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Get.put(ArchivedWebController());

    final ArchivedWebController archivedC = Get.find();
